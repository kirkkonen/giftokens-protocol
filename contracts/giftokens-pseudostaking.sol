 ...
 */
contract GiftokensStaking is Context, Ownable, IERC20, IERC20Metadata {
    ...
    // Giftokens modification
    ERC20 private _giftokenERC20;
    address private _originContract;
    address public _relayer;

    // end of Giftokens modification
    ...
    //relayer calls stake
    function stakeFromRelayer(
        address beneficiary, 
        uint256 amount) public returns (bool) {
        
        stakes[beneficiary]+=amount;
        _giftokenERC20.safeTransferFrom(_originContract, address(this), amount);
        _mint(beneficiary, amount*2);
        return true;
    }

    function getStake(address beneficiary) public view returns(uint256) {
        return stakes[beneficiary];
    }
    // end of Giftokens modification
